<?php namespace Zenit\Bundle\DBAccess\Component\SmartAccess;
...
abstract class AbstractSmartAccess {
	/** @var \Zenit\Bundle\DBAccess\Component\PDOConnection\AbstractPDOConnection */
	private $connection;
	...
	public function buildSQL(string $sql, array $sqlParams = []): string {
		$this->connection->applySQLParameters($sql, $sqlParams);
	/*	if (count($sqlParams)) {
